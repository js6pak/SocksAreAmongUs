Shader "Unlit/PlayerShader"
{
    Properties
    {
        ...
        _BackColor ("Shadow Color", Color) = (0.47, 0.03, 0.21, 1)
        _BodyColor ("Body Color", Color) = (0.77, 0.06, 0.06, 1)
        _VisorColor ("VisorColor", Color) = (0.584, 0.792, 0.863, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 col = fixed4(
                    saturate(_BodyColor.rgb * ocol.r + _VisorColor.rgb * ocol.g + _BackColor.rgb * ocol.b), ocol.a);
                ...
                col = lerp(col, fixed4(d, d, d, col.a), _Desat);
